...
const Header = () => {
  ...
  return (
    ...
    viewport={{once:true}}
    >
      <motion.div className='text-stone-500 inline-flex text-center gap-2 bg-white px-6 py-1 rounded-3xl border border-neutral-500'
     ...
     <motion.p className='text-center mx-auto max-w-xl mt-5'
        initial={{opacity:0,y:20}}
        animate={{opacity:1,y:0}}
